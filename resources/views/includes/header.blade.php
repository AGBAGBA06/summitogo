      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-8 text-center text-lg-right">
          <ul class="list-inline">
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="{{ URL::to('loogin') }}">Se connecter</a></li>
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="{{ URL::to('signup') }}">S'inscrire</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@courses">
              <a class="nav-link" href="{{URL::to('cours')}}">COURS</a>
            </li>

            <li class="nav-item active">
              <a class="nav-link" href="{{URL::to('events')}}">EVENEMENTS</a>
            </li>
